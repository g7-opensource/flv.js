...
内容：0（白噪声）
*/
const simulateAccLen = 698;
const simulateAcc = new Uint8Array([ 
    0x01, 0x40, 0x42, 0x80, 0xa3, 0x7f, 0xf8, 0x85, 0x2d, 0x2d, 0x2d, 0x2d, 0x2d, 0x2d, 0x2d, 0x2d, 0x2d, 
    ...
    , 
    ...
    0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 
    0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 
    0x5a, 0x5d, 0xf0, 0xe2, 0x14, 0xb4, 0xb4, 0xb4, 0xb4, 0xb4, 0xb4, 0xb4, 0xb4, 0xb4, 0xb4, 0xb4, 0xb4, 0xb4, 0xb4, 0xb4, 0xb4, 0xb4, 0xb4, 0xb4, 
...
const PLAYER_SPEED_SLOW_20 = 20;

const PLAYER_SPEED_SLOW_10 = 10;

const PLAYER_SPEED_FAST_5 = -5;

class FLVDemuxer {

    constructor(probeData, config, mediaElement, bufferSize) {
        this.TAG = 'FLVDemuxer';
    ...
    parseChunks(chunk, byteStart) {
        ...
        while (offset < chunk.byteLength) {
            ...
            if (this._mediaElement.buffered.length) {
                const end = this._mediaElement.buffered.end(0);
            ...
            switch (tagType) {
                case 8:  // Audio
                    ...
                    if (this._lastAudioOrgTs == -1) {
                        ...
                        let off = (timestamp > this._lastAudioOrgTs ? timestamp - this._lastAudioOrgTs : 1);
                ...
                case 9:  // Video
                    ...
                    if (this._lastVideoOrgTs == -1) {
                        ...
                        let off = (timestamp > this._lastVideoOrgTs ? timestamp - this._lastVideoOrgTs : 1);
                        //根据延迟动态创建缓冲区
                        if (this._bufferSize > 0) {
                            if (delay < this._bufferSize * 2 / 3) {
                                off = off + PLAYER_SPEED_SLOW_20;
                            }
                            else if (delay < this._bufferSize) {
                                off = off + PLAYER_SPEED_SLOW_10;
                            }
                            else {
                                off = off + PLAYER_SPEED_FAST_5;
                            }
                        }
                        this._lastVideoTs = this._lastVideoTs + off;
    ...
    _pushSeimulateAcc() {
        if (this._lastAudioTs + 128 <= this._lastVideoTs) {
            ...
            let dts = this._timestampBase + this._lastAudioTs;
            let aacSample = {unit: simulateAcc, length: simulateAccLen, dts: dts, pts: dts};
    ...
    _parseHVCVideoPacket(arrayBuffer, dataOffset, dataSize, tagTimestamp, tagPosition, frameType) {
        if (dataSize < 4) {
            Log.w(this.TAG, 'Flv: Invalid HVC packet, missing HVCPacketType or/and CompositionTime');
            return;
        }
    ...
    _parseHVCDecoderConfigurationRecord(arrayBuffer, dataOffset, dataSize) {
        ...
        if (vpsCount === 0) {
            this._onError(DemuxErrors.FORMAT_ERROR, 'Flv: Invalid HVCDecoderConfigurationRecord: No VPS');
            return;
        } else if (vpsCount > 1) {
            Log.w(this.TAG, `Flv: Strange HVCDecoderConfigurationRecord: VPS Count = ${vpsCount}`);
        }

        if (spsCount === 0) {
            this._onError(DemuxErrors.FORMAT_ERROR, 'Flv: Invalid HVCDecoderConfigurationRecord: No SPS');
            return;
        } else if (spsCount > 1) {
            Log.w(this.TAG, `Flv: Strange HVCDecoderConfigurationRecord: SPS Count = ${spsCount}`);
        }

        if (ppsCount === 0) {
            this._onError(DemuxErrors.FORMAT_ERROR, 'Flv: Invalid HVCDecoderConfigurationRecord: No PPS');
            return;
        } else if (ppsCount > 1) {
            Log.w(this.TAG, `Flv: Strange HVCDecoderConfigurationRecord: PPS Count = ${spsCount}`);
        }
    ...
    _parseHVCVideoData(arrayBuffer, dataOffset, dataSize, tagTimestamp, tagPosition, frameType, cts) {
        let le = this._littleEndian;
        let v = new DataView(arrayBuffer, dataOffset, dataSize);
